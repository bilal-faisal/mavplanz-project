...
export const metadata = {
  title: "Mavstratz - Home",
  description: "Mavstratz home page",
};
  ...
  return (
    <div>
      <div className="min-h-screen bg-gradient-to-b md:bg-gradient-to-br from-blue-400 to-green-400 md:from-blue-500 md:to-green-500 flex items-center justify-center">
        <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-y-8 py-12 px-14 md:py-14 md:px-20 text-center bg-white bg-opacity-25 rounded-xl shadow-lg backdrop-filter backdrop-blur-lg">
